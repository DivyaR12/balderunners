...
// AD8232 pins
const int AD8232Output = A0; // Assuming you've connected the output to A0
...
void setup() {
  ...
  // Create a new CSV file and write the header, add ECG column
  File dataFile = SD.open(fileName, FILE_WRITE);
  if (dataFile) {
    Serial.print("Logging to: ");
    Serial.println(fileName);
    // Include ECG Data in the header
